...
public class OauthLoginServlet extends HttpServlet {
    ...
    response.sendRedirect(aurl+"?redirect_uri=http://localhost:8080/MindPulpy1/OauthCallBackServlet&response_type=code&client_id="+apikey);
    else
    response.sendRedirect(aurl+"?redirect_uri=http://localhost:8080/MindPulpy1/OauthCallBackServlet&response_type=code&client_id="+apikey+"&"+scope_label+"="+scope_value);
