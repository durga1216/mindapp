...
public class XmlRpcSerializer
{
    ...
    public XmlRpcSerializer( boolean addCustomSerializers )
    {
        ...
        {
            customSerializers.add( new com.roobi.pulpy.LongPrimitiveSerializer() );
            customSerializers.add( new com.roobi.pulpy.LongWrapperSerializer() );
            customSerializers.add( new com.roobi.pulpy.MapSerializer() );
            customSerializers.add( new com.roobi.pulpy.ListSerializer() );
            customSerializers.add( new com.roobi.pulpy.CollectionSerializer() );
            customSerializers.add( new com.roobi.pulpy.ObjectArraySerializer() );
            customSerializers.add( new com.roobi.pulpy.IntArraySerializer() );
            customSerializers.add( new com.roobi.pulpy.FloatArraySerializer() );
            customSerializers.add( new com.roobi.pulpy.LongArraySerializer() );
            customSerializers.add( new com.roobi.pulpy.DoubleArraySerializer() );
            customSerializers.add( new com.roobi.pulpy.BooleanArraySerializer() );
            customSerializers.add( new com.roobi.pulpy.IntrospectingSerializer() );
        }
    }
