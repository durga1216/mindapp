...
public class XmlRpcSerializer
{
    ...
    public XmlRpcSerializer( boolean addCustomSerializers )
    {
        ...
        {
            customSerializers.add( new com.xmlrpc.LongPrimitiveSerializer() );
            customSerializers.add( new com.xmlrpc.LongWrapperSerializer() );
            customSerializers.add( new com.xmlrpc.MapSerializer() );
            customSerializers.add( new com.xmlrpc.ListSerializer() );
            customSerializers.add( new com.xmlrpc.CollectionSerializer() );
            customSerializers.add( new com.xmlrpc.ObjectArraySerializer() );
            customSerializers.add( new com.xmlrpc.IntArraySerializer() );
            customSerializers.add( new com.xmlrpc.FloatArraySerializer() );
            customSerializers.add( new com.xmlrpc.LongArraySerializer() );
            customSerializers.add( new com.xmlrpc.DoubleArraySerializer() );
            customSerializers.add( new com.xmlrpc.BooleanArraySerializer() );
            customSerializers.add( new com.xmlrpc.IntrospectingSerializer() );
        }
    }
