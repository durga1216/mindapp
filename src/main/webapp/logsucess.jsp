...
<div id=na><%=session.getAttribute("mail")%> &nbsp;|&nbsp;<a id="indiv" href='API_promotion.jsp'>API Promotion</a>&nbsp;|&nbsp;<a id="indiv" href= 'APIthon.jsp'>APIthon</a>&nbsp;|&nbsp;<a id='indiv' href = 'mobile_client.jsp'> API Test </a>&nbsp;|&nbsp;<a id='indiv' href='<%=request.getContextPath()%>/ApiPulpy'>API Usage</a>&nbsp;|&nbsp;<a id='indiv' href='login.jsp'> Sign Out </a></div>
