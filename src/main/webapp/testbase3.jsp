...
<body>
<form action="TicketPulpy" method="post">
<center><h1><font color="red"><b>Ticket EndPoint</b></font></h1></center>
<table align="center" width="600" height="300">
<tr><td><font color="blue">Ticket_Booking_URL</td><td><input type="text" name="t1"></font></td></tr>
